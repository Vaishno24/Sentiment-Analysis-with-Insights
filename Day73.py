...
def check_review(reviewText):
    ...
    """ The reviewText should be vectorised, so the vectorizer is loaded and a 
        a transform method is created """
...
def create_app_ui():
    ...
    html.H2(children = "Pie Chart",style = {'text-align':'center','text-decoration':'bold'}),
    html.P([html.Img(src=app.get_asset_url('sentiment.png'),style={'width':'600px','height':'400px'})],style={'text-align':'center'}),
    html.Hr(style={'background-color':'black'}),
    html.H2(children = "WordCloud",style = {'text-align':'center','text-decoration':'bold'}),
    html.P([html.Img(src=app.get_asset_url('wordCloud.png'),style={'width':'600px','height':'400px'})],style={'text-align':'center'}),
    html.Hr(style={'background-color':'black'}),
    html.H2(children = "Select Review",style = {'text-align':'center','text-decoration':'bold'}),
    dcc.Dropdown(
                id='Chart_Dropdown', 
                  options=chart_dropdown_values,
                  placeholder = 'Select a Review',style={'font-size':'20px','height':'50px'}
                    ),
    html.H1(children = '-',id='sentiment1',style={'text-align':'center'}),
    html.Hr(style={'background-color':'black'}),
    html.H2(children = "Find the Sentiment of Your Review",style = {'text-align':'center','text-decoration':'bold'}),
    dcc.Textarea(
        id = 'textarea_review',
    ...
    html.H1(children = '-', id='result',style={'text-align':'center'})
...
# Main method Function to control the Flow of your Project
def main():
